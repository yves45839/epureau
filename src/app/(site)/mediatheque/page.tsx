...
export default async function Mediatheque(){
 ...
 return <><PageHeader fil={["Médiathèque"]} titre={t("f001","Photos de chantiers, films institutionnels et documentation")} lead={t("f002","Découvrez nos réalisations et nos documents de présentation.")} />
