...
Les interactions et les styles des carrousels sont partagés avec la page React via `carousels.js` et `carousels.css`. L’animation automatique s’arrête au survol, au focus, lors d’une navigation manuelle et lorsque la bannière ou l’onglet ne sont plus visibles. La préférence de réduction des animations laisse uniquement la navigation manuelle.
