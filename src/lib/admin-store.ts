...
const localPath = () => path.join(process.cwd(), ".local", process.env.ADMIN_LOCAL_DATASET === "products-test" ? "products-test.json" : process.env.ADMIN_LOCAL_DATASET === "builder-test" ? "builder-test.json" : process.env.ADMIN_LOCAL_DATASET === "translation-test" ? "translation-test.json" : "admin.json");
