...
export async function generateMetadata({params}:Props):Promise<Metadata> {
  ...
  return {title:product ? `${product.nom} — ${product.marque}` : "Produit",description:product?.texte};
}
