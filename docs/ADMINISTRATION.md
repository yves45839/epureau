...
Les textes de référence des pages publiques, réalisations, produits génériques et médias disposent aussi de traductions anglaises intégrées. Elles servent de secours lorsqu’aucune traduction CMS valide n’est disponible et ne modifient pas les données françaises en base. Une traduction CMS correspondant au français actuel reste prioritaire. Les nouveaux textes saisis par l’équipe doivent toujours être traduits, relus et publiés depuis le panneau Version anglaise. Les noms de marques, références, coordonnées et fichiers PDF originaux restent inchangés ; les libellés affichés sont localisés séparément.
