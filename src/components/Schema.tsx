  ...
  return (
    <div ref={ref}>
      <div className="diagram"  data-stage={stage} aria-hidden="true">
              <div className="hd"><span>Schéma de principe · STEP biologique</span><b className="st" >{libelle}</b></div>
              <svg className="dg" viewBox="0 0 640 330">
                ...
                <text className="dim" x="120" y="56">Ø 3,2 m</text><text className="dim" x="318" y="44">V = 96 m³</text><text className="dim" x="500" y="56">Q = 270 m³/j</text><text className="dim" x="26" y="106">EH entrée</text>
                ...
                <text className="lbl" x="172" y="200" textAnchor="middle">Bassin tampon</text>
                ...
                <text className="lbl" x="365" y="216" textAnchor="middle">Réacteur MBBR / SBR</text>
